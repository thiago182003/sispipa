...
@endpush
@push('scripts')
{{-- <script> var urlsituacoes = ;</script> --}}
...
<script src={{ asset('/js/pages/situacoes.js') }}></script>
{{-- <script src={{ asset('/js/pages/app-user-list.js') }}></script> --}}
@endpush

@section('content')
    <input type="hidden" value="{{route('administrativo.situacoes.getall')}}" id="urlSituacoes" name="urlSituacoes" />
    <!-- Users List Table -->
    <div class="card">
        <div class="card-header border-bottom">
            <h5 class="card-title mb-0">Buscar Situações</h5>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddUser" aria-labelledby="offcanvasAddUserLabel">
            <div class="offcanvas-header border-bottom">
                <h5 id="offcanvasAddUserLabel" class="offcanvas-title">Adicionar Situação</h5>
