...
<script src={{ asset('/js/pages/postograduacoes.js') }}></script>
{{-- <script src={{ asset('/js/pages/app-user-list.js') }}></script> --}}
@endpush

@section('content')
    <input type="hidden" value="{{route('administrativo.pg.getall')}}" id="urlInstituicoes" name="urlInstituicoes" />
    <!-- Users List Table -->
    <div class="card">
        <div class="card-header border-bottom">
            <h5 class="card-title mb-0">Buscar Postos e Graduações</h5>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddUser" aria-labelledby="offcanvasAddUserLabel">
            <div class="offcanvas-header border-bottom">
                <h5 id="offcanvasAddUserLabel" class="offcanvas-title">Adicionar Postos/Graduações</h5>
            ...
            <div class="offcanvas-body mx-0 flex-grow-0 p-6 h-100">
                <form class="add-new-user pt-0" id="form-instituicao" onsubmit="return false">
                    ...
                    <div class="mb-6 form-control-validation">
                        ...
                        <input type="text" id="sigla" name="sigla" class="form-control" placeholder="Sigla da instituição"
                            aria-label="Sigla da instituição"/>
                    </div>
                    <div class="mb-6 form-control-validation">
                        <label class="form-label" for="sigla">Imagem</label>
                        <input type="text" id="img" name="img" class="form-control" placeholder="Imagem da instituição"
                            aria-label="Imagem da instituição"/>
                    </div>
