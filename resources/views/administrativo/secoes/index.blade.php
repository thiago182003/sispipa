...
<script src={{ asset('/js/pages/secoes.js') }}></script>
{{-- <script src={{ asset('/js/pages/app-user-list.js') }}></script> --}}
@endpush

@section('content')
    <input type="hidden" value="{{route('administrativo.secoes.getall')}}" id="urlSecao" name="urlSecao" />
    <!-- Users List Table -->
    <div class="card">
        <div class="card-header border-bottom">
            <h5 class="card-title mb-0">Buscar Seções</h5>
        </div>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddUser" aria-labelledby="offcanvasAddUserLabel">
            <div class="offcanvas-header border-bottom">
                <h5 id="offcanvasAddUserLabel" class="offcanvas-title">Adicionar seção</h5>
            ...
            <div class="offcanvas-body mx-0 flex-grow-0 p-6 h-100">
                <form class="add-new-user pt-0" id="form-secao" onsubmit="return false">
                    ...
                    <div class="mb-6 form-control-validation">
                        ...
                        <input type="text" id="sigla" name="sigla" class="form-control" placeholder="Sigla da seção"
                            aria-label="Sigla da seção"/>
                    </div>
                    <div class="mb-6 form-control-validation">
                        <label class="form-label" for="sigla">Om</label>
                        <select id="selectoms" class="form-select">
                    ...
                    <div class="mb-6 form-control-validation">
                        <label class="form-label" for="select-secoes">Seção</label>
                        <select id="selectsecoes" class="form-select">
                            <option value="">Selecione uma OM primeiro...</option>
                        </select>
                    </div>
