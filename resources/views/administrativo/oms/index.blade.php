...
<script src={{ asset('/js/pages/oms.js') }}></script>
{{-- <script src={{ asset('/js/pages/app-user-list.js') }}></script> --}}
@endpush

@section('content')
    <input type="hidden" value="{{route('administrativo.oms.getall')}}" id="urlOm" name="urlOm" />
    <!-- Users List Table -->
    <div class="card">
        <div class="card-header border-bottom">
            <h5 class="card-title mb-0">Buscar Organizações Militares</h5>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddUser" aria-labelledby="offcanvasAddUserLabel">
            ...
            <div class="offcanvas-body mx-0 flex-grow-0 p-6 h-100">
                <form class="add-new-user pt-0" id="form-oms" onsubmit="return false">
                    @csrf
                    ...
                    <div class="mb-6 form-control-validation">
                        ...
                        <select id="select-oms" class="form-select">
                    ...
                    <div class="mb-6 form-control-validation">
                        ...
                        <div class="mt-2">
                            <img id="preview-img" src="" alt="Pré-visualização" class="img-thumbnail d-none" width="150">
                        </div>
                    </div>
