...
document.addEventListener("DOMContentLoaded", function (e) {
    ...
    dataTable = new DataTable(table, {
        ajax: '/operacional/tipomissoes/getall',
        columns: [
            { data: "nome" },
            { data: "descricao" },
            { data: "Ações" }
        ...
        layout: {
            ...
            topEnd: {
                features: [{
                    ...
                    // },
                    {
                        text: '<i class="icon-base bx bx-plus icon-sm me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Adicionar Tipo de missão</span>',
    ...
    FormValidation.formValidation(document.getElementById('form-instituicao'), {
        ...
        $.post('/operacional/tipomissoes/store', {
            id: id.value,
            nome: nome.value,
            ...
            Swal.fire({
                icon: "success",
                title: "Salvar",
                text: "Tipo de missão salvo com sucesso!",
            ...
            Swal.fire({
                ...
                text: "Ocorreu um erro ao tentar salvar o Tipo de Missão.",
...
function editar(id) {
    $.ajax({
        url: '/operacional/tipomissao/show',
        method: 'GET',
        data: {
            id: id,
        },
...
function confirmarExclusao(id) {
    ...
    Swal.fire({
        ...
        if (resultado.isConfirmed) {
            ...
            $.post('/operacional/tipomissao/delete', { id: id })
                .done((resposta) => {
                    Swal.fire({
                        icon: "success",
                        title: "Deletado",
