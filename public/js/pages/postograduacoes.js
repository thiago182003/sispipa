    ...
    FormValidation.formValidation(document.getElementById('form-instituicao'), {
        ...
        $.post('/administrativo/pg/store', {
            ...
            Swal.fire({
                icon: "success",
                title: "Salvo",
                text: "Posto/Grasduação salvo com sucesso!",
            ...
            Swal.fire({
                ...
                text: "Ocorreu um erro ao tentar salvar Posto/Grasduação.",
        ...
        if (resultado.isConfirmed) {
            if (!id) {
                Swal.fire({
                    icon: "error",
                    title: "Erro",
                    text: "ID do Posto/Grasduação não encontrado!",
                    customClass: { confirmButton: "btn btn-danger" }
                });
                return;
            }
            ...
            $.post('/administrativo/pg/delete', { id: id })
                .done((resposta) => {
                    Swal.fire({
                        icon: "success",
                        title: "Deletado",
                ...
                .fail(() => {
                    Swal.fire({
                        ...
                        text: "Ocorreu um erro ao tentar excluir o Posto/Grasduação.",
                        customClass: { confirmButton: "btn btn-danger" }
                    });
                });
        }
