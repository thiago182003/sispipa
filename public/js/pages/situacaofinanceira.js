...
document.addEventListener("DOMContentLoaded", function (e) {
    ...
    let table = document.querySelector(".dt-complex-header");
        ...
        layout: {
            ...
            topEnd: {
                features: [{
                    ...
                    {
                        text: '<i class="icon-base bx bx-plus icon-sm me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Adicionar situação financeira</span>',
                        className: "add-new btn btn-primary abrir",
                        attr: {
...
function editar(id) {
    $.ajax({
        ...
        success: function (response) {
            ...
            // Redireciona para /financeiro/create com dados pré-preenchidos como query string
            var params = $.param({
                id: response.id,
                nome: response.nome
            });
            window.location.href = '/financeiro/create?' + params;
        },
        error: function (xhr) {
