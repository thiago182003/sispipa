...
document.addEventListener("DOMContentLoaded", function (e) {
            ...
            topEnd: {
                features: [{
                    ...
                    buttons: [{
                        ...
                        text: '<i class="icon-base bx bx-plus icon-sm me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Adicionar OMs</span>',
    ...
    setTimeout(() => {
        ...
        , 100);
    FormValidation.formValidation(document.getElementById('form-oms'), {
        fields: {
            nome: {
                validators: {
                    notEmpty: {
        ...
        $.post('/administrativo/oms/store', {
            ...
            Swal.fire({
                ...
                text: "Ocorreu um erro ao tentar salvar a oms.",
...
function editar(id){
    $.ajax({
        ...
        success: function (response) {
            ...
            $("#select-oms").val(response.superior_id);
            // $("#select-oms").change();
        },
        error: function (xhr) {
...
function confirmarExclusao(id) {
    Swal.fire({
        ...
        if (resultado.isConfirmed) {        
            ...
            $.post('/administrativo/oms/delete', { id: id })
                .done((resposta) => {
                    Swal.fire({
                        icon: "success",
                        title: "Deletado",
                ...
                .fail(() => {
                    Swal.fire({
                        icon: "error",
                        title: "Erro ao deletar",
                        text: "Ocorreu um erro ao tentar excluir a OM.",
                        customClass: { confirmButton: "btn btn-danger" }
                    });
                });
        }
