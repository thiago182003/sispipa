            ...
            topEnd: {
                features: [{
                    ...
                    buttons: [{
                        ...
                        text: '<i class="icon-base bx bx-plus icon-sm me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Adicionar Situação</span>',
...
function editar(id){
    $.ajax({
        url: '/administrativo/situacoes/show',
        method: 'POST',
        data: {
            id: id,
        },
        ...
        if (resultado.isConfirmed) {
            if (!id) {
                Swal.fire({
                    icon: "error",
                    title: "Erro",
                    text: "ID da Situação não encontrado!",
                    customClass: { confirmButton: "btn btn-danger" }
                });
                return;
            }
            ...
            $.post('/administrativo/situacoes/delete', { id: id })
                .done((resposta) => {
                    Swal.fire({
                        icon: "success",
                        title: "Deletado",
                ...
                .fail(() => {
                    Swal.fire({
                        ...
                        text: "Ocorreu um erro ao tentar excluir a Situação.",
                        customClass: { confirmButton: "btn btn-danger" }
                    });
                });
        }
