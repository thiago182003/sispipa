...
document.addEventListener("DOMContentLoaded", function (e) {
    ...
    dataTable = new DataTable(table, {
        ajax: '/administrativo/modulos/getall',
        columns: [
            { data: "nome" },
            { data: "Ações" }
        ],
        ...
        layout: {
            ...
            topEnd: {
                features: [{
                    ...
                    // },
                    {
                        text: '<i class="icon-base bx bx-plus icon-sm me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Adicionar modulo</span>',
    ...
    FormValidation.formValidation(document.getElementById('form-instituicao'), {
        ...
        $.post('/administrativo/modulos/store', {
            id: id.value,
            nome: nome.value,
...
function editar(id) {
    $.ajax({
        url: '/administrativo/modulos/show',
        method: 'GET',
        data: {
            id: id,
        },
...
function confirmarExclusao(id) {
    ...
    Swal.fire({
        ...
        if (resultado.isConfirmed) {
            ...
            $.post('/administrativo/modulos/delete', { id: id })
                .done((resposta) => {
                    Swal.fire({
                        icon: "success",
                        title: "Deletado",
